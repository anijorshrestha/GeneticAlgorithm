function [nfe,BestCost]=galgo(nVar,MaxIt,nPop,pc,pm,mu,beta,TournamentSize,ANSWER,crossover)
...
% Store Best Solution
disp('Store Best Solution')
BestSol=pop(1);


% Array to Hold Best Cost Values
disp(' Array to Hold Best Cost Values')
...
disp('Array to Hold Number of Function Evaluations')
nfe=zeros(MaxIt,1);
assignin('base','betatest',beta);
assignin('base','Coststest',Costs);
assignin('base','WorstCosttest',WorstCost);
...
for it=1:MaxIt
    ...
    for k=1:nc/2
        ...
        % Apply Crossover
        [popc(k,1).Position popc(k,2).Position]=Crossover(p1.Position,p2.Position,crossover);
